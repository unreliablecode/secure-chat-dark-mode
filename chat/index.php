...
<body style="background-color: #222; color: #fff; font-family: Arial, sans-serif; display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh; margin: 0;">

  <h1 class="justify-content-left d-inline">unreliablecode</h1>
  ...
  <?php if(isset($_SESSION['uid']) && isset($_SESSION['username'])): ?>
    ...
    <h1 style="text-align: center; font-size:48px; color=#6696ba;" class="animate__animated animate__fadeIn"><?php echo "Welcome, <strong>".$_SESSION['username']; ?></strong>&nbsp<i style="font-size:16px;" class='fas fa-circle align-middle text-success'></i></h1>
    ...
    <div class="modal fade fast" id="chatModal" tabindex="-1" aria-labelledby="chatModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content" style="background: rgba(255, 255, 255, 0.2); border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); backdrop-filter: blur(10px); text-align: center;">
          <div class="modal-header">
            <h5 class="modal-title fw-light" id="chatModalLabel">Chat with </h5>
            <div class="animate__animated animate__fadeInDown animate__faster" id="last-seen" style="font-style:italic; font-size:10px; font-weight:300; color:#6696ba; float:right; margin-top:5px; margin-left:5px;">Status</div>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="mb-3">
            <div id="chat-box" style="height:500px; background-color:rgba(87,136,173,0.2); border:1px solid #ddd; overflow: auto; padding:16px; margin: 25px 15px 0px 15px; border-radius:8px;"></div>
          </div>
          <div class="modal-body">
            <form href="" method="POST">
              <div class="mb-3">
                ...
                <select id="enc-method" style="margin-top:15px; padding:8px; cursor:pointer; border-radius:8px; background-color:#8a8a8a; width: 100%;">
